...
$tripQuery1 = "SELECT DISTINCT tripNo, trainNo FROM TrainSchedule WHERE scheduleId BETWEEN 2001 AND 3000";
...
foreach ($trips1 as $tripNo) {
    $scheduleData1[$tripNo] = getScheduleData($conn, $tripNo, 2001, 3000);
}
...
<head>
    ...
    <title>ETS Schedule - NexRail</title>
...
<div class="container">
    ...
    <table class="schedule-table weekday">
        <tr>
            <td colspan="10">ETS North - South Service Timetable</td>
        </tr>
        <tr>
                    <td>Trip No</td>
